...
function Coronavirus({ hederText, subHeader }) {
  return (
    <Row>
      <Col className="imagen1">
        <div>
          <h1 className="hederText">{hederText}</h1>
          <p className="pH">{subHeader}</p>
        </div>
          ...
          <div>
            <Row>
              ...
              <Col lg={12} className="iconos2">
                <svg width="25" height="25" className="q">
                  <g
                  // fill-rule="evenodd"
                  >
                ...
                <svg className="q cs kl" width="25" height="25">
                  <path
