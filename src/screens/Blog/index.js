...
class Blog extends Component {
  render() {
    return (
      <div>
        <Title>The One Book That Will Change Your Life</Title>
        <Title level={2}>And allow you to live by different rules.</Title>
        <Paragraph ellipsis>
          ...
          For obvious reasons, that festival isn’t happening.
        </Paragraph>
        <p>
        ...
        <p>
          But this doesn’t mean planning is futile. It’s just evidence that most
          people don’t plan particularly well.
        </p>
        <p>
          Even if life is unknowable, the process of thinking through the future
          can ensure that whatever future does arrive, you’re better prepared to
          deal with it. Planning is a beneficial use of your time whatever
          happens.
        </p>
        <h3>
        ...
        <p>
          ...
          as more enjoyable than watching TV. Yet how many of us spend evenings
          and weekends watching TV because we haven’t made the effort to call
          friends and make plans to get together?
        </p>
        <p>
          ...
          first making a plan. The coronavirus was unforeseen, but many plans do
          happen, and some activities (for example, anything requiring a
          reservation) are impossible without some forethought.
        </p>
        <h3>
          Planning helps people see both good and bad possibilities, and prepare
          for them
        </h3>
        <p>
          For example, after intense snowstorms in the winter of 2009 and 2010,
          the federal government began requiring all agencies to have a telework
          policy spelling out who could reasonably work from home and how they’d
          do it. These plans weren’t written with the Covid-19 pandemic in mind,
          but their existence meant that most agencies were able to continue
          operations.
        </p>
        ...
        <p>
          ...
          reading a novel than students who were asked simply to think about the
          personal tasks they wanted to complete. In other words, once there was
          a plan, their brains could let the matter go and turn to other things.
        </p>
        <p>
          ...
          from January until April. Then I began to realize that my plans looked
          unlikely. But those three months of freed up mental space aren’t
          nothing. The plans turned out to be useless, but planning gave me a
          break.
        </p>
      </div>
    );
