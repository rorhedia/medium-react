      ...
      <div>
        <Row>
          ...
          >
            ...
            />
            <Paragraph>
              I’m supposed to be at a music festival in Germany right now, not
              at home writing this column. My friend and I made the plans months
              ago. For obvious reasons, that festival isn’t happening.
            </Paragraph>
            <Paragraph>
              ...
              school-aged children would be during July and August. Now all
              those camps have been canceled as well.
            </Paragraph>
            <Paragraph>
              When nothing goes according to plan, it’s tempting to conclude
              that planning is a giant waste of time. Life is unknowable.
              Perhaps the hours I spent organizing my children’s summer should
              have been spent playing with them instead.
            </Paragraph>
            <Paragraph>
              ...
              to-do list items never get done. And just 15% of “dones” started
              as “to-do” items. We don’t do a lot of the things we plan, and we
              do a lot of things we don’t plan.
            </Paragraph>
            <Paragraph>
            ...
            <Paragraph>
              ...
              prepared to deal with it. Planning is a beneficial use of your
            ...
            <Paragraph>
              When it comes to moment-by-moment happiness, people rate
              socializing as more enjoyable than watching TV. Yet how many of us
              spend evenings and weekends watching TV because we haven’t made
              the effort to call friends and make plans to get together?
            </Paragraph>
            <Paragraph>
              Or take my Germany trip. With all my kids to be accounted for, and
              a husband who also has a job, I wouldn’t have been able to go
              without first making a plan. The coronavirus was unforeseen, but
              many plans do happen, and some activities (for example, anything
              requiring a reservation) are impossible without some forethought.
            </Paragraph>
            <Title level={4}>
            ...
            <Paragraph>
              ...
              2010, the federal government began requiring all agencies to have
              a telework policy spelling out who could reasonably work from home
              and how they’d do it. These plans weren’t written with the
              Covid-19 pandemic in mind, but their existence meant that most
              agencies were able to continue operations.
            </Paragraph>
            ...
            <Paragraph>
              ...
              Picture yourself having trouble falling asleep because your brain
              is working through the presentation you know you need to write in
              the morning.
            </Paragraph>
            <Paragraph>
